...
#define FILE_NAME_LEN128
#define SIZE_OF_VERSION_DATA_BUF64
#define PATH_BUFF_SIZE128
#define DB_NAME_SIZE64
#define DB_USER_NAME_SIZE64
#define DB_PASSWORD_NAME_SIZE64

#define CONFIG_KEY_WORD_BUF_SIZE128
...
} CONFIG_INFO_KEY_WORD_ID;CONFIG_INFO_KEY_WORD_ID//Should correspond with structure CONFIG_INFO.
...
}CONFIG_INFO;CONFIG_INFO//Should correspond with structure CONFIG_INFO_KEY_WORD_ID and CONFIG_INFO.
